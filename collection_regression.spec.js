it('Bag Selection', () => {
      ...
      it.only('Transfer Bags to Shipper', () => {
        ...
        regressionCollectionSteps.collectionBagTransfer.coiMissingValue()
      }),
      ...
      it.only('Shipping Summary', () => {
        ...
        cy.waitForElementAndClick(`tr[data-testid="treatment-${scope.coi}"]`);
        regressionCollectionSteps.collectionShippingChecklist.happyPath(scope.coi,scope.treatmentInformation,scope, scope.patientInformation)
